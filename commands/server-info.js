...
module.exports = {
    run: message => {
        message.channel.send(new Discord.MessageEmbed()
            ...
            .addField('Total', `${message.guild.memberCount} membres\n${message.guild.members.cache.filter(member => !member.user.bot). size} humains\n${message.guild.members.cache.filter(member => member.user.bot). size} bot`, true)
    ...
    guildOnly: true,
    help: {
        description: 'Permet d\'avoir des informations sur le serveur discord.',
        syntax: ''
    }
}