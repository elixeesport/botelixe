...
module.exports = {
    run: async (message, args, client) => {
        ...
        if (!client.db.warns[member.id]) return message.channel.send('Ce membre n\'a comis aucun crime félicitaions à toi !')
    ...
    guildOnly: true,
    help: {
        description: 'Permet de voir les infractions donné par les membre du staff.',
        syntax: '<@membre>'
    }
}
